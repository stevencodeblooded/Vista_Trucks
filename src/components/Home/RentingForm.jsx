          ...
          <form onSubmit={handleFormSubmission} className="max-w-2xl mx-auto flex flex-col gap-4">
            <div className="grid grid-cols-2 gap-4">
              <div className="flex flex-col gap-1">
                ...
                <input type="text" name="fname" id="fname" value={formData.fname} onChange={handleChange} className="border border-black rounded focus:outline-red-600 px-3 py-2" />
              </div>
              <div className="flex flex-col gap-1">
                <label htmlFor="cname" className="font-semibold">Company Name</label>
                <input type="text" name="cname" id="cname" value={formData.cname} onChange={handleChange} className="border border-black rounded focus:outline-red-600 px-3 py-2" />
              </div>
            </div>
            <div className="grid grid-cols-2 gap-4">
              <div className="flex flex-col gap-1">
                <label htmlFor="email" className="font-semibold">Email</label>
                <input type="email" name="email" id="email" value={formData.email} onChange={handleChange} className="border border-black rounded focus:outline-red-600 px-3 py-2" />
              </div>
              <div className="flex flex-col gap-1">
            ...
            <div className="flex flex-col gap-2">
              ...
              <textarea name="message" id="message" value={formData.message} onChange={handleChange} rows={3} className="border px-3 py-2 border-black rounded focus:outline-red-600"></textarea>
            </div>
